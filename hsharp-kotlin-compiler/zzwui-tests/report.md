...
**Generated:** 2026-06-20 22:55:13  
**Total wall time:** 235.263 s  
...
| --- | --- |
| Total test files | **37** |
| Test files passed (all cases) | **34** |
| Test files with at least one failing case | 0 |
| Test files failed at compile | 0 |
| Test files failed at runtime | 3 |
| Test files timed out (> 60s) | 3 |
| File-level pass rate | **91.9%** |
| Total individual check() cases | **843** |
| Total individual cases passed | **843** |
| Total individual cases failed | **0** |
| Case-level pass rate | **100.00%** |
| Avg compile time |   102.6 ms |
| Avg run time (Kotlin VM) |   6.255 s |
...
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | :---: |
| 1 | `01_widget_core` | `widget` |   101.5 ms |   124.3 ms | 0 |   225.7 ms | 120 | 0 | **OK** |
| 2 | `02_renderer` | `renderer` |    91.1 ms |   117.6 ms | 0 |   208.7 ms | 51 | 0 | **OK** |
| 3 | `03_window` | `window` |    86.7 ms |   106.1 ms | 0 |   192.8 ms | 29 | 0 | **OK** |
| 4 | `04_native` | `native` |    81.8 ms |   103.8 ms | 0 |   185.6 ms | 35 | 0 | **OK** |
| 5 | `05_layout_stress` | `layout` |    78.9 ms |   122.5 ms | 0 |   201.5 ms | 31 | 0 | **OK** |
| 6 | `06_event_dispatch` | `event` |    76.5 ms |   102.4 ms | 0 |   178.9 ms | 16 | 0 | **OK** |
| 7 | `07_widget_tree` | `tree` |    75.5 ms |   135.7 ms | 0 |   211.2 ms | 22 | 0 | **OK** |
| 8 | `08_primitives` | `primitive` |    88.5 ms |   126.5 ms | 0 |   215.0 ms | 25 | 0 | **OK** |
| 9 | `09_style` | `styling` |    78.3 ms |   100.7 ms | 0 |   179.0 ms | 44 | 0 | **OK** |
| 10 | `10_state_machines` | `state` |    76.4 ms |   115.4 ms | 0 |   191.8 ms | 32 | 0 | **OK** |
| 11 | `11_collections` | `collection` |    76.2 ms |   113.8 ms | 0 |   190.0 ms | 33 | 0 | **OK** |
| 12 | `12_text_input` | `input` |    75.7 ms |   113.7 ms | 0 |   189.4 ms | 34 | 0 | **OK** |
| 13 | `13_renderer_clip` | `clip` |    88.3 ms |   119.6 ms | 0 |   207.9 ms | 27 | 0 | **OK** |
| 14 | `14_perf` | `performance` |    88.3 ms |   167.2 ms | 0 |   255.5 ms | 22 | 0 | **OK** |
| 15 | `15_for_loop` | `syntax` |    90.5 ms |   111.5 ms | 0 |   202.0 ms | 18 | 0 | **OK** |
| 16 | `16_async_await` | `syntax` |    91.6 ms |   112.8 ms | 0 |   204.4 ms | 16 | 0 | **OK** |
| 17 | `17_parallel_channel` | `runtime` |    93.1 ms |  3793.3 ms | 0 |   3.886 s | 27 | 0 | **OK** |
| 18 | `18_raytrace_bench` | `performance` |    94.1 ms |  2578.9 ms | 0 |   2.673 s | 4 | 0 | **OK** |
| 19 | `19_match_propagation` | `syntax` |    93.6 ms |   120.6 ms | 0 |   214.2 ms | 37 | 0 | **OK** |
| 20 | `20_stdlib_modules` | `?` |   102.4 ms |   256.3 ms | 0 |   358.7 ms | 32 | 0 | **OK** |
| 21 | `30_raytracer_pipeline` | `?` |   144.9 ms |   478.3 ms | 0 |   623.2 ms | 22 | 0 | **OK** |
| 22 | `31_raytracer_demo` | `?` |   133.5 ms |  2478.9 ms | 0 |   2.612 s | 0 | 0 | **OK** |
| 23 | `32_raytracer_window` | `?` |   114.0 ms | 60017.6 ms | -9 |  60.132 s | — | — | **TIMEOUT** |
| 24 | `33_window_smoke` | `?` |   109.3 ms | 60015.2 ms | -9 |  60.125 s | — | — | **TIMEOUT** |
| 25 | `34_color_swatch` | `?` |   141.1 ms | 60013.1 ms | -9 |  60.154 s | — | — | **TIMEOUT** |
| 26 | `35_raytracer_fullscreen` | `?` |   166.7 ms | 10461.3 ms | 0 |  10.628 s | 0 | 0 | **OK** |
| 27 | `36_raytracer_debug` | `?` |   139.9 ms |   156.5 ms | 0 |   296.4 ms | 0 | 0 | **OK** |
| 28 | `37_raytracer_seqtile` | `?` |   116.7 ms |   490.7 ms | 0 |   607.4 ms | 0 | 0 | **OK** |
| 29 | `38_jframe_dump` | `?` |   119.8 ms |  2470.7 ms | 0 |   2.591 s | 0 | 0 | **OK** |
| 30 | `39_jframe_selfie` | `?` |   112.1 ms |  4691.6 ms | 0 |   4.804 s | 0 | 0 | **OK** |
| 31 | `40_raytracer_record` | `?` |   161.4 ms | 20781.8 ms | 0 |  20.943 s | 0 | 0 | **OK** |
| 32 | `_hconcepts_smoke` | `?` |   107.7 ms |   118.9 ms | 0 |   226.6 ms | 0 | 0 | **OK** |
| 33 | `_parallel_smoke` | `?` |    91.0 ms |   177.5 ms | 0 |   268.6 ms | 0 | 0 | **OK** |
| 34 | `_test_minimal` | `?` |    90.1 ms |   109.0 ms | 0 |   199.1 ms | 0 | 0 | **OK** |
| 35 | `h_concepts` | `?` |   112.6 ms |    95.6 ms | 0 |   208.1 ms | 0 | 0 | **OK** |
| 36 | `test_concepts` | `?` |   111.9 ms |   131.2 ms | 0 |   243.1 ms | 166 | 0 | **OK** |
| 37 | `test_generics` | `?` |    92.8 ms |   112.5 ms | 0 |   205.4 ms | 0 | 0 | **OK** |
...
| 17 | `17_parallel_channel` | `runtime` | Multi-threaded DZZW scheduler: @parallel fn / parallel fn (both yield is_parallel=true); await on parallel Future<T>; concurrent { } block joins on child tasks; structured-concurrency exception propagation; chan T (unbounded/bounded) + chan_send/recv/close/try_recv/size; chan_try_send on full channel returns false; chan_try_recv returns nullptr on empty; send on closed channel raises; parallelism() reports worker-pool size. |
| 18 | `18_raytrace_bench` | `performance` | Raytracer benchmark: 240x180 image of 3 spheres rendered with 4 samples/pixel, depth 6.  Sequential vs parallel (10 worker pool, 10 tiles via concurrent { }).  Asserts parallel render produces an identical bitmap and is >=2x faster (target: 2x+ speedup for CPU-bound work). |
| 19 | `19_match_propagation` | `syntax` | v0.4.1: pattern matching (wildcard / binding / literal / type / variant / chan_send / chan_recv / chan_close) + error-propagation `?` postfix + guards + exhaustiveness raising. |
| 20 | `20_stdlib_modules` | `?` | ? |
| 21 | `30_raytracer_pipeline` | `?` | ? |
| 22 | `31_raytracer_demo` | `?` | ? |
| 23 | `32_raytracer_window` | `?` | ? |
| 24 | `33_window_smoke` | `?` | ? |
| 25 | `34_color_swatch` | `?` | ? |
| 26 | `35_raytracer_fullscreen` | `?` | ? |
| 27 | `36_raytracer_debug` | `?` | ? |
| 28 | `37_raytracer_seqtile` | `?` | ? |
| 29 | `38_jframe_dump` | `?` | ? |
| 30 | `39_jframe_selfie` | `?` | ? |
| 31 | `40_raytracer_record` | `?` | ? |
| 32 | `_hconcepts_smoke` | `?` | ? |
| 33 | `_parallel_smoke` | `?` | ? |
| 34 | `_test_minimal` | `?` | ? |
| 35 | `h_concepts` | `?` | ? |
...
### `17_parallel_channel` — `runtime`

```text
PARALLEL_TEST : PASS=27 FAIL=0
```
- **PASS=27, FAIL=0**

### `18_raytrace_bench` — `performance`

```text
RAYTRACE_BENCH : PASS=4 FAIL=0
```
- **PASS=4, FAIL=0**

### `19_match_propagation` — `syntax`

```text
MATCH_PROP_TEST : PASS=37 FAIL=0
```
- **PASS=37, FAIL=0**
...
```text
ASSERT_TEST : PASS=32 FAIL=0
```
- **PASS=32, FAIL=0**

### `30_raytracer_pipeline` — `?`

```text
ASSERT_TEST : PASS=22 FAIL=0
```
- **PASS=22, FAIL=0**
...
### `35_raytracer_fullscreen` — `?`

```text
=== H# Raytracer Fullscreen ===
=== done ===
```
- **PASS=0, FAIL=0**
...
```text
=== render_pixel probe ===
=== primary_ray probe at center ===
=== intersect_sphere direct test ===
=== closest_hit(scene, ray) ===
```
- **PASS=0, FAIL=0**

### `37_raytracer_seqtile` — `?`

```text
=== sequential tile render of three_spheres ===
=== image stats ===
```
- **PASS=0, FAIL=0**
...
```text
=== T39 fullscreen JFrame self-screenshot ===
=== done ===
```
- **PASS=0, FAIL=0**
...
```text
=== H# Raytracer - Window + Screen Recording ===
=== done ===
```
- **PASS=0, FAIL=0**
...
### `32_raytracer_window` — failure

- **Stage:** run (timed out after 60s)
- **stderr:** `[TIMEOUT after 60s]`

### `33_window_smoke` — failure

- **Stage:** run (timed out after 60s)
- **stderr:** `[TIMEOUT after 60s]`

### `34_color_swatch` — failure
...
- **34/37** test files fully passed (**843/843**
  individual cases).  See §6 for the failing tests.
