...
**Generated:** 2026-07-04 21:18:17  
**Total wall time:** 3.215 s  
...
| Avg compile time |    62.0 ms |
| Avg run time (Kotlin VM) |   167.1 ms |
...
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | :---: |
| 1 | `01_math_lib` | `math` |    92.7 ms |   151.5 ms | 0 |   244.2 ms | 76 | 0 | **OK** |
| 2 | `02_string_lib` | `string` |    59.2 ms |   138.7 ms | 0 |   197.9 ms | 51 | 0 | **OK** |
| 3 | `03_array_lib` | `array` |    58.6 ms |   145.3 ms | 0 |   204.0 ms | 55 | 0 | **OK** |
| 4 | `04_dict_lib` | `dict` |    51.6 ms |   133.3 ms | 0 |   184.9 ms | 20 | 0 | **OK** |
| 5 | `05_class_lib` | `oop` |    59.0 ms |   153.6 ms | 0 |   212.7 ms | 38 | 0 | **OK** |
| 6 | `06_recursion_lib` | `algorithms` |    62.8 ms |   217.5 ms | 0 |   280.2 ms | 58 | 0 | **OK** |
| 7 | `07_higher_order_lib` | `functional` |    58.4 ms |   204.3 ms | 0 |   262.7 ms | 47 | 0 | **OK** |
| 8 | `08_algorithm_lib` | `algorithms` |    73.6 ms |   220.8 ms | 0 |   294.4 ms | 46 | 0 | **OK** |
| 9 | `09_numeric_lib` | `numeric` |    64.2 ms |   146.3 ms | 0 |   210.6 ms | 33 | 0 | **OK** |
| 10 | `10_iterator_lib` | `functional` |    55.5 ms |   221.1 ms | 0 |   276.7 ms | 41 | 0 | **OK** |
| 11 | `11_oo_design_lib` | `oop` |    62.8 ms |   193.6 ms | 0 |   256.4 ms | 36 | 0 | **OK** |
| 12 | `12_edge_case_lib` | `edge` |    57.0 ms |   128.1 ms | 0 |   185.0 ms | 64 | 0 | **OK** |
| 13 | `13_simulation_lib` | `simulation` |    57.6 ms |   135.4 ms | 0 |   193.0 ms | 41 | 0 | **OK** |
| 14 | `14_perf_lib` | `performance` |    55.0 ms |   150.4 ms | 0 |   205.4 ms | 42 | 0 | **OK** |
